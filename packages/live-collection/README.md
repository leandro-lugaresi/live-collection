...
The backend is yours: the client speaks a small wire contract — one catchup endpoint and one SSE stream — defined in [`@leandro-lugaresi/live-collection-protocol`](https://github.com/leandro-lugaresi/live-collection/tree/main/packages/protocol). Implement it on any stack, or use the optional Effect kernel [`@leandro-lugaresi/live-collection-server`](https://www.npmjs.com/package/@leandro-lugaresi/live-collection-server).
...
- [Getting started](https://github.com/leandro-lugaresi/live-collection/blob/main/docs/getting-started.md) — the step-by-step implementer guide.
- [Collections](https://github.com/leandro-lugaresi/live-collection/blob/main/docs/collections.md) — `defineCollection`, scoping, optimistic writes, lifecycle.
- [Persistence](https://github.com/leandro-lugaresi/live-collection/blob/main/docs/persistence.md) — local SQLite setup and behavior.
- [Architecture](https://github.com/leandro-lugaresi/live-collection/blob/main/docs/architecture.md) — how sync works underneath.
- [Backend contract](https://github.com/leandro-lugaresi/live-collection/blob/main/docs/backend.md) — what your server must provide.
